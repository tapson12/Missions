                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$structure->profil}}</td>
                      <td>
                          <button  data-toggle="modal" data-target="{{'#modifier'.$structure->id}}"  class="btn btn-outline-success"><i style="color: #007bff"  class="fa fa-edit"></i></button>
                     ...
                     <div class="row">
                      ...
                      <div class="row">
                        <div class="col-lg-12 col-sm-12  col-md-12">
                          ...
                          <a href="{{url('/delete-type-structure/'.$structure->id)}}" class="btn btn-danger">supprimer <i class="fa fa-trash" style="color: white"></i></a>
                        </div>
                      </div>
                   </div>
                 </div>
